...
- No banner; no checkout/module/replace tree; first dep is not described as a half-plan.
...
func Assert(t *testing.T, d *session.Doctest, req *Request, resp *Response, err error) {
	...
	assertNotContains(t, resp.Stdout, "would: replace")
	assertNotContains(t, resp.Stdout, "replace  ")
